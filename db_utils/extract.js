...
const fs = require('fs');
const csvWriter = require('csv-write-stream'); // You can install this package with npm install csv-write-stream
...
async function main() {
  ...
  writer.pipe(fs.createWriteStream('registrations.csv'));
