...
function Day() {
  return (
    ...
    <div className="justify-center mx-auto pt-10">
      ...
      <div className='bg-red-500 p-5 flex justify-center flex-col sm:flex-row'>
        <p className='text-center'>In a day at The Qube, we&nbsp; </p>
        <TypewriterText texts={["Apply Modern Teaching Methods", "Balance Quality vs. Quantity of Information", "Appreciate Differentiation and Individuality", "Aim for Positive Emotional Attachment to Religion","Believe in Social Binding"]}/>
      </div>
