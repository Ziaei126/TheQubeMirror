...
export default function Success() {
  ...
  return (
    <div className="flex items-center justify-center ">
      <div className="text-center p-6 bg-blue-200 rounded-lg shadow-md max-w-2xl w-full">
        ...
        {donation && (
          <div>
            <p className="text-lg mb-6">
            We deeply appreciate your generous donation! Your support to the Lady Khadija Scholarship Program helps us empower more students in our community.
            </p>
          </div>
        )}
          <div>
